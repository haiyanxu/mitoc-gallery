    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='albums', on_delete=models.CASCADE, verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='images', on_delete=models.CASCADE, verbose_name='User', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ('order', 'id'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(blank=True, on_delete=models.CASCADE, to=swapper.get_model_name('imagestore', 'Album'), help_text='Select an album to add these images to. leave this empty to create a new album from the supplied title.', null=True)),
            ],
            options={
                ''
        ...
        migrations.AddField(
            model_name='image',
            name='album',
            field=models.ForeignKey(related_name='images', on_delete=models.CASCADE, verbose_name='Album', blank=True, to=swapper.get_model_name('imagestore', 'Album'), null=True),
            preserve_default=True,
        ),
    ]
